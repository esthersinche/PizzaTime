...
public class JMXSetup {
    ...
    public static void registrarMBeansensist() {//para llamar a este metodo cuando se quiera enseñar las notifs
        ...
        try {
            ...
            //solo si no esta registrado pq anda poniendose dos veces pipipi
            if (!mbeanser.isRegistered(objnm)) {
                ...
                System.out.println("ayuda, si paso se esta registrando");
            }else{
                System.out.println("nada broer, ya estaba registrado?");
            }
